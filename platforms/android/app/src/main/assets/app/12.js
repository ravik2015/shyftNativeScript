...
/***/ 310:
/*!*********************************************************!*\
  !*** ./appointmentlisting/appointmentlisting.module.ts ***!
  \*********************************************************/
/*! dynamic exports provided */
/*! all exports used */
/***/ (function(module, exports, __webpack_require__) {
...
var appointmentlisting_routing_module_1 = __webpack_require__(/*! ./appointmentlisting-routing.module */ 547);
var appointmentlisting_component_1 = __webpack_require__(/*! ./appointmentlisting.component */ 488);
var AppointmentlistingModule = (function () {
    function AppointmentlistingModule() {
    }
    AppointmentlistingModule = __decorate([
        core_1.NgModule({
            imports: [
                nativescript_module_1.NativeScriptModule,
                appointmentlisting_routing_module_1.AppointmentlistingRoutingModule
            ],
            declarations: [
                appointmentlisting_component_1.AppointmentlistingComponent
            ],
            schemas: [
                core_1.NO_ERRORS_SCHEMA
            ]
        })
    ], AppointmentlistingModule);
    return AppointmentlistingModule;
}());
exports.AppointmentlistingModule = AppointmentlistingModule;
...
/***/ 488:
/*!************************************************************!*\
  !*** ./appointmentlisting/appointmentlisting.component.ts ***!
  \************************************************************/
/*! dynamic exports provided */
/*! all exports used */
/***/ (function(module, exports, __webpack_require__) {
...
var appointmentlisting_services_1 = __webpack_require__(/*! ./appointmentlisting.services */ 548);
...
var AppointmentlistingComponent = (function () {
    ...
    AppointmentlistingComponent = __decorate([
        core_1.Component({
            ...
            /*duleId: module.i*/
            styles: [__webpack_require__(/*! ./appointmentlisting.css */ 549)],
            template: __webpack_require__(/*! ./appointmentlisting.component.html */ 550),
...
/***/ 547:
/*!*****************************************************************!*\
  !*** ./appointmentlisting/appointmentlisting-routing.module.ts ***!
  \*****************************************************************/
/*! dynamic exports provided */
/*! all exports used */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 548:
/*!***********************************************************!*\
  !*** ./appointmentlisting/appointmentlisting.services.ts ***!
  \***********************************************************/
/*! dynamic exports provided */
/*! all exports used */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 549:
/*!***************************************************!*\
  !*** ./appointmentlisting/appointmentlisting.css ***!
  \***************************************************/
/*! dynamic exports provided */
/*! all exports used */
/***/ (function(module, exports) {

module.exports = ".my-class{color:red}.default{color:green}.default2{color:green}\n"

/***/ }),

/***/ 550:
/*!**************************************************************!*\
  !*** ./appointmentlisting/appointmentlisting.component.html ***!
  \**************************************************************/
/*! dynamic exports provided */
/*! all exports used */
/***/ (function(module, exports) {

module.exports = "\r\n<GridLayout columns=\"*\" rows=\"*,9*\">\r\n        <StackLayout col=\"0\" row=\"0\" style=\"background-color: black\" >\r\n                <GridLayout columns=\"*,8*,*\" rows=\"*\">\r\n                                <StackLayout col=\"0\" row=\"0\">\r\n                                         <Label class=\"h2 fa\" text=\"&#xf060;\" (onTap)=\"onBack()\" style=\"horizontal-align: left; color: white; padding: 20 0 0 10 \"></Label>     \r\n                                </StackLayout>\r\n                                <StackLayout col=\"1\" row=\"0\" style=\"vertical-align: center\">\r\n                                        <Label class=\"h2\" text=\"Service History\"  style=\" color: white; text-align: center\"></Label>                                                                                                                                                                             \r\n                                </StackLayout>\r\n                                <StackLayout col=\"2\" row=\"0\"></StackLayout>                                        \r\n                </GridLayout>                                        \r\n        </StackLayout>  \r\n        <ListView  col=\"0\" row=\"1\" [visibility]=\"!datastate ? 'visible' : 'collapsed'\" [items]=\"appointments\">\r\n                <ng-template tkListItemTemplate let-item=\"item\" let-index=\"index\">\r\n                        <Gridlayout columns=\"8*,2*\" rows=\"*\" style=\"padding: 10;\" (onTap)=\"itemTapped(args, item, index)\">\r\n                                <StackLayout col=\"0\" row=\"0\">\r\n                                        <Label [text]=\"'Serviced at : '+item?.vendor?.name\" style=\"color: black; text-align: left\"></Label>\r\n                                        <Label [text]=\"item?.datetime\" style=\"color: black; text-align: left\"></Label>\r\n                                </StackLayout>\r\n                                <StackLayout col=\"1\" row=\"0\">\r\n                                        <Label class=\"h3 fa\" [text]=\"item?.status\" [ngClass]=\"{'my-class': item?.status == 'pending','my-class': item?.status == 'Pending', 'default': item?.status == 'active', 'default2': item?.status == 'Lead', 'default2': item?.status == 'Paid'}\"></Label>\r\n                                </StackLayout>\r\n                        </Gridlayout>\r\n        </ng-template>\r\n        </ListView>  \r\n        <ActivityIndicator column=0 row=1 [busy]=\"datastate\" width=\"100\" height=\"100\" class=\"activity-indicator\"></ActivityIndicator>                        \r\n \r\n</GridLayout>\r\n    \r\n"
